...
@JvmName("smoothstepDDouble")
inline fun <reified D:Any> ((D)->Double).smoothstep(noinline edge0:(D)->Double, noinline edge1: (D)->Double) : (D)->Double {
    return smoothstep(edge0, edge1, this@smoothstep)
}